  ...
  return (
    <div className="animate-fadein text-xl">
        ...
        <div className="bg-primary-darker p-12 py-20 md:pb-32 text-center">
            <h1 className=" text-7xl font-black text-primary-bold mb-2 opacity-0 animate-appear">Hi, I'm Bengin</h1>
            ...
            <div className="bg-primary-dark text-primary-white p-12 pt-24 lg:pt-12 mx-auto max-w-7xl xl:rounded-xl shadow-md">
                <div className="relative">
                    <div className="absolute right-1/2 transform translate-x-1/2 -top-40 lg:-top-28 xl:right-16 xl:translate-x-0 transition-all hover:-translate-y-2 duration-300">
                        <img
                            className="w-36 h-36 object-cover rounded-xl transition-all hover:shadow-hover transform hover:scale-110 opacity-0 animate-appear"
                            src="/portrait.png"
                ...
                <div className="md:flex md:items-center">
                    ...
                    <div>
                        <h1 className="text-4xl text-primary-bold font-semibold mb-4 opacity-0 animate-appear">About</h1>
                        <div className="leading-6 opacity-0 animate-appear text-primary-font">
                            <p className="mb-4">
        ...
        <div className="bg-primary-darker pb-16">
            ...
            <div className="mx-auto text-center text-primary-font max-w-7xl">
                ...
                <div className="md:flex p-12 xl:rounded-lg bg-primary-dark mb-16 shadow-md">
                ...
                <div className="md:flex p-12 xl:rounded-lg bg-primary-dark shadow-md">
